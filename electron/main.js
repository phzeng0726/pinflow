...
function updateTrayMenu() {
  ...
  const menu = Menu.buildFromTemplate([
    {
      label: pinWindow ? (pinWindow.isVisible() ? 'Hide Pin Window' : 'Show Pin Window') : 'Open Pin Window',
...
app.whenReady().then(async () => {
  ...
  try {
    ...
    console.warn('[main] Backend health check failed — continuing anyway:', e.message)
  }
