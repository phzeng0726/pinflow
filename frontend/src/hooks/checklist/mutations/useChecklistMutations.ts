...
export function useChecklistMutations(cardId: number) {
  ...
  return { createChecklist: createList, deleteChecklist: deleteList, createChecklistItem: createItem, updateChecklistItem: updateItem, deleteChecklistItem: deleteItem }
}
