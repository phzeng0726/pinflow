...
export const getCard = (id: number) =>
  client.get<Card>(`/cards/${id}`).then((r) => r.data)
export const createCard = (
  ...
  client
    .post<Card>(`/columns/${columnId}/cards`, { title, description })
    .then((r) => r.data)
...
export const moveCard = (id: number, columnId: number, position: number) =>
  client
    .patch<Card>(`/cards/${id}/move`, { column_id: columnId, position })
    .then((r) => r.data)
export const togglePin = (id: number) =>
  client.patch<Card>(`/cards/${id}/pin`).then((r) => r.data)
export const deleteCard = (id: number) => client.delete(`/cards/${id}`)
export const getPinnedCards = () =>
  client.get<PinnedCard[]>('/cards/pinned').then((r) => r.data)
