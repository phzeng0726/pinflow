...
- **THEN** system creates checklist and returns `{id, cardId, title, items: []}` with HTTP 201
...
- **THEN** response includes `"completedCount": 2, "totalCount": 5` on the checklist object
