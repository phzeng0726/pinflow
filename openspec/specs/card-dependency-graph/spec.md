...
Card dependency graph view allows users to visualize relationships between cards as an interactive directed graph. Users can toggle between the traditional board view and graph view, explore dependencies with focus/highlight mode, filter and search cards, and switch between layout modes.
...
Graph View 卡片節點 SHALL 依到期狀態顯示彩色邊框，優先順序：overdue > soon > in-progress。
