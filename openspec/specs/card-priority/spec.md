...
Define the card priority field and its UI interactions. Cards support an optional priority level (1–5) that can be set, updated, or cleared via the card detail dialog.
