# Spec: checklist-markdown-mode

## Purpose

為 checklist 提供 Markdown 編輯模式，使用者可在 UI 模式與 Markdown 模式之間切換，以文字方式批次新增、編輯、刪除 checklist 項目。後端提供 PUT 同步端點，以智慧 diff 方式保留既有 item ID。
