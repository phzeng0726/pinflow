# Spec: i18n Full Coverage

## Purpose

確保 `zh-TW.json` 與 `en-US.json` 完整覆蓋所有 UI 可見字串，並讓 Zod schema 驗證訊息、toast 通知及確認框文案均支援多語系。Zod schema 改為 factory 函式，mutation hook 改為使用 i18n 取代硬編碼字串。
